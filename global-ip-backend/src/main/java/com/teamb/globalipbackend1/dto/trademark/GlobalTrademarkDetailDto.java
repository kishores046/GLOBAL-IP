...
public class GlobalTrademarkDetailDto {
    ...
    private String id;              // trademark id / application number
    private String markName;         // brand name
    private String jurisdiction;     // US, EU, IN, etc.
    ...
    private boolean bookmarked;      // user-specific
}
