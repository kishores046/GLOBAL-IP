...
import com.teamb.globalipbackend1.external.trendAnalysisClient.config.PatentAnalyticsServiceConfig;
...
@Slf4j
public class PatentTrendClientImpl implements PatentTrendClient {
