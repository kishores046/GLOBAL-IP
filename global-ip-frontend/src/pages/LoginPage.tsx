        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-xl p-8 md:p-10">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-gray-900 hover:bg-gray-800 text-white rounded-lg transition-all flex items-center justify-center gap-3 shadow-sm hover:shadow"
              disabled={isLoading}
            >
