 ...
 * Shows what the analyst is subscribed to - nothing else.
 * 
 * DESIGN PHILOSOPHY:
 * - Truthful UI over decorative UI
 * - Backend-driven state only
 * - Minimal, audit-friendly layout
 */
            ...
            {!loading && !error && subscriptions.length === 0 && (
              <div className="bg-white rounded-lg border border-slate-200 p-12 text-center shadow-sm">
                ...
                <p className="text-slate-600 mb-6">
                  Create a subscription to start tracking patents, competitors, and trademarks.
                </p>
                <button
